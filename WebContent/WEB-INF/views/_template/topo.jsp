...
<div class="menu">
	<ul id="menu">
		...
		<li>
			<div onclick="location.href='cadastraCarro?codigo=<c:if test="${UsuarioSessao.usuario.carroSelecionado}" >${UsuarioSessao.usuario.carro.codigo}</c:if><c:if test="${not UsuarioSessao.usuario.carroSelecionado}" >0</c:if>';">
				Garagem
			</div>
			<ul>
