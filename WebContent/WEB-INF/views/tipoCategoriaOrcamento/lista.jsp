...
<body>
	...
	<form id="frmLista" action="cadastraTipoCategoriaOrcamento">
									...
									<div class="miniBotoes">
										<div>
											<input id="btAlterar" type="button"
												onclick="window.location.href='cadastraTipoCategoriaOrcamento?codigo=${entidade.codigo}'"
												value="Alterar" />
										</div>
									</div>
								</div>
									...
									<div class="miniBotoes">
										<div>
											<input id="btExcluir" type="button"
												onclick="window.location.href='removeTipoCategoriaOrcamento?codigo=${entidade.codigo}'"
												value="Excluir" />
										</div>
									</div>
								</div>
